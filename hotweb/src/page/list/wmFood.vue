...
<script>
    ...
    export default {
        ...
        methods: {
            initCategory(){
                const url = window.fdConfig.url.feature.category+"?type=1";
                const _this = this;
                this.$http.get(url,{
                }).then(function(res){
            ...
            exportExcel(){
                location.href = "http://localhost:8080/hg/export/food/1";
            },
            handleSizeChange() {
            },
            ...
            handleEdit(row,t) {
                if(t){
                    ...
                    this.flag = true;
                    this.selectTable = {imgUrl:'',categoryId:'',type:1,valid:true};
                }
