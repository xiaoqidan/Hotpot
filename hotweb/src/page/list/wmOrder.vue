                ...
                <el-table-column label="操作" width="200">
                    <template slot-scope="scope">
                        ...
                        <el-button
                            ...
                            type="primary"
                            v-if="scope.row.status === 1"
                            @click="handleWm(scope.row)">设置配送员</el-button>
                    </template>
                </el-table-column>
            </el-table>
                    ...
                    <el-row class="query">
                        ...
                        <el-col :span="12">
                            <el-form-item label="配送员：" label-width="100px">
                                <label >{{selectTable.psy}}</label>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="配送员电话：" label-width="100px">
                                <label >{{selectTable.psyPhone}}</label>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
            </el-dialog>
            <el-dialog title="订单配送" v-model="dialogWm"  >
                <el-form :model="selectTable" >
                    <el-row class="query">
                        <el-col :span="12">
                            <el-form-item label="用户名称：" label-width="100px">
                        ...
                        <el-col :span="12">
                            <el-form-item label="用户电话：" label-width="100px">
                                <label >{{location.telephone}}</label>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="订单价格：" label-width="100px">
                        ...
                        <el-col :span="12">
                            <el-form-item label="配送员：" label-width="100px" >
                                <el-input v-model="selectTable.psy"  type="text"  :max='50'  style="display:inline-block;width: 200px;" show-word-lmit></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="配送员联系电话：" label-width="150px" >
                                <el-input v-model="selectTable.psyPhone"  type="text"  :max='50'  style="display:inline-block;width: 200px;" show-word-lmit></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
                <div slot="footer" class="dialog-footer" >
                    <el-button @click="dialogWm = false">取 消</el-button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            exportExcel(){
                location.href = "http://localhost:8080/hg/export/order/2";
            },
            resetData(){
                this.query = {};
                this.getOrders();
            ...
            handleWm(row) {
                this.selectTable = Object.assign({},row);
                this.location = this.selectTable.location;
                this.dialogWm = true;
            },
            updateStatus(row){
                if(typeof(this.selectTable.psy) ==='undefined' || this.selectTable.psy === null || this.selectTable.psy === '' ){
                    this.$message('请输入配送员');
                    return
                }
                if(typeof(this.selectTable.psyPhone) ==='undefined' || this.selectTable.psyPhone === null ||this.selectTable.psyPhone === '' ){
                    this.$message('请输入有效电话号码');
                    return
                }
                ...
                var data = {
                    ...
                    status:this.selectTable.status + 1,
                    psy:this.selectTable.psy,
                    psyPhone:this.selectTable.psyPhone
                }
